## SOURCE: https://github.com/aupfred/EasyABC/blob/playback-mac-mplay/
...
class MPlaySMFPlayer(MidiPlayer):
    ...
    def Seek(self, time):
        ...
        setsong(self.midi_file, tick=time)

    def Length(self):
        # [WJS] 2023-11-20: Length needs to return int.
        return int(self.midi_file.playing_time)
